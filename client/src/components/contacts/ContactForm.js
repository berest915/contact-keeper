...
const ContactForm = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            {/*//! radios */}
            <h4>Contact-Type</h4>
            <input type="radio" id='personal' style={rem25}
                name="type"
                value='personal'
                checked={type === 'personal'}
                onChange={onChange}
            />
            <label htmlFor="personal" style={rem50} >Personal</label>{' '}

            <input type="radio" id='professional' style={rem25}
                name="type"
                value='professional'
                checked={type === 'professional'}
                onChange={onChange}
            />
            <label htmlFor="professional" style={rem50} >Professional</label>
